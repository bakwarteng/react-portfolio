    ...
    <div className="container pt-4">
      ...
      <p>
        <p>
          ...
          have experience in various web technologies including JavaScript,
          React, HTML, JavaScript and CSS.
        </p>
        <p>
          I am a student of  the University of Texas' fullstack development bootcamp During my
          studies, I developed a keen interest in front-end development and have
          since worked on numerous projects to hone my skills. My expected graduation date is June 17, 2024.
        </p>
        <p>
          ...
          coding, you can find me at Les Mills workout classes, the Star Cinema Grille, or at the Farmer's Market.
        </p>
        <p>
