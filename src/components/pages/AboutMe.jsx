    ...
    <div className="container pt-4">
      ...
      <p>
        <p>
          ...
          experience in various web technologies including Mongo, Express, Node, React,
          HTML, JavaScript, and CSS.
        </p>
        <p>
          I am a student of the University of Texas' fullstack development
          bootcamp During my studies, I developed a keen interest in fullstack
        ...
        <p>
          ...
          coding, you can find me at Les Mills workout classes, playing the Sims 4, watching movies at the Star Cinema
